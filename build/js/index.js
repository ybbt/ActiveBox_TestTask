          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return ApiService.callApi(this.API_URL, 'GET');
...
function () {
  function Features() {
    ...
    this._eventsAssign()._render();
  }

  _createClass(Features, [{
    key: "_eventsAssign",
    value: function _eventsAssign() {
    ...
    value: function _render() {
      ...
      this.model._list.forEach(function (el, i) {
        var template = _this2.templateFeatures.cloneNode(true);
    ...
    key: "addItems",
    value: function () {
      var _addItems = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2() {
        var collectionService, tmpList, listRandom, index;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                tmpList = _context2.sent;
                listRandom = [];

                for (index = 0; index < this.model._list.length; index++) {
...
/*#__PURE__*/
function () {
  function FastScroll(menuItemSelector) {
    _classCallCheck(this, FastScroll);

    this.anchors = [].slice.call(document.querySelectorAll(
    /*'._menuScroll'*/
    menuItemSelector));
  ...
  _createClass(FastScroll, [{
    key: "_scroll",
    value: function _scroll(animationTime, framesCount) {
      var coordY = document.querySelector(this.getAttribute('data-dest')).getBoundingClientRect().top;
